...
class Initialize:
    ...
    def __init__(self):
        ...
        self.in_t = params.in_t
        self.in_sd = params.in_sd
        self.in_rh = params.in_rh
        self.in_wv = params.in_wv
        self.in_w5 = params.in_w5
        self.in_w6 = params.in_w6
        self.in_p_forecast = params.in_p_forecast
        self.in_t_forecast = params.in_t_forecast
        self.in_sd_forecast = params.in_sd_forecast
        self.in_rh_forecast = params.in_rh_forecast
        self.in_wv_forecast = params.in_wv_forecast
