...
input_size = in_p + in_p_forecast + in_t + in_t_forecast + in_sd + in_sd_forecast + \
    in_rh + in_rh_forecast + in_wv + in_wv_forecast + in_w5 + in_w_forecast + in_w6 + in_w_forecast
